...
import com.example.remindertask.presentation.screens.intro.slide.SlideShowPageAdapter
...
class IntroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        vp.adapter = SlideShowPageAdapter(this.requireActivity())
        ...
        finBtn.setOnClickListener {
            ...
            this.findNavController().navigate(IntroFragmentDirections.introToMain())
        }
        return binding.root
    }
